        ...
        <div>
            ...
            <div class="top__content-company-detail">
                <div class="top__content-company-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/k.niina.jpg" alt="新名さんの写真"></src>
        ...
        <div>
            ...
            <div class="top__content-service-detail">
                <div class="top__content-service-image">
                    <img src="<?php echo get_template_directory_uri(); ?>/assets/logo_ProGeeC_1.jpg" alt="事業のイメージ画像or幾何学的な画像"></src>
                </div>
